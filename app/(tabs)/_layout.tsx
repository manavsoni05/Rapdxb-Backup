  ...
  return (
    <View style={[styles.tabIconOuter, focused && styles.tabIconOuterFocused]}>
      <LinearGradient
        ...
        <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
          <Path
            d="M20.25 8.511C21.134 8.795 21.75 9.639 21.75 10.608V14.894C21.75 16.03 20.903 16.994 19.77 17.087C19.43 17.114 19.09 17.139 18.75 17.159V20.25L15.75 17.25C14.396 17.25 13.056 17.195 11.73 17.087C11.436 17.013 11.166 16.882 10.905 16.845M20.25 8.511C20.097 8.471 19.938 8.439 19.774 8.416C17.358 8.175 14.902 8.071 12.452 8.109M20.25 8.511V6.637C20.25 5.016 19.098 3.611 17.49 3.402C15.448 3.137 13.365 3 11.25 3C9.135 3 7.052 3.137 5.01 3.402C3.402 3.611 2.25 5.016 2.25 6.637V12.863C2.25 14.484 3.402 15.889 5.01 16.098C5.587 16.173 6.167 16.238 6.75 16.292V21L10.905 16.845M12.452 8.109C11.321 8.203 10.476 9.166 10.476 10.301V14.587C10.476 15.424 10.936 16.167 11.631 16.538M12.452 8.109V6.637C12.452 5.016 11.3 3.611 9.692 3.402"
            stroke={focused ? '#1a1a1a' : '#ffffff'}
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
